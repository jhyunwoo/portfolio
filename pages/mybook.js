        ...
        <div className={'m-4 bg-gray-100 w-full p-4 shadow-xl rounded-xl'}>
          ...
          <div>
            ...
            <p className={'text-xl'}>
              ...
              담고 있는 '스티브 잡스'를 추천합니다. 스티브 잡스에 대한 거의 모든 내용을 담고 있어
              분량이 길지만 스티브 잡스가 걸었던 인생을 이해할 수 있고 아이폰과 아이패드 등 애플의
              발전 과전 또한 볼 수 있어 저에게 매우 인상깊었습니다. 창업을 생각하고 있는 친구라면 한
              번 읽어보면 좋을 것 같습니다.
            </p>
          </div>
        </div>

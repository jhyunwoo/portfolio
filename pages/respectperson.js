...
import st from '../public/Alan_Turing.jpg';
import Link from 'next/link';

export default function InCNSA() {
  return (
    <div className={'w-full bg-gray-50 dark:bg-gray-900 flex flex-col'}>
      <div className={' text-center text-3xl font-bold p-24 dark:text-white'}>존경하는 인물</div>
      <div className={'flex'}>
        <div className={'m-4 bg-gray-100 w-full p-4 shadow-xl rounded-xl dark:bg-gray-800'}>
          <div className={'text-2xl font-semibold m-2 dark:text-white'}>앨런 매시슨 튜링</div>
          <div>
            <Image
              src={st}

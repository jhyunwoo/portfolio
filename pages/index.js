  ...
  return (
    <div className="transition w-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="transition basis-2/3 h-min my-auto">
          <div className="transition m-4 p-2 h-full flex flex-col dark:text-white">
            ...
            <div className="transition text-lg">
              저는 충남삼성고등학교에 재학중인 전현우입니다. 인공지능, 웹, 앱 등 다양한 분야에
              관심이 많아 여러 분야에서 공부하고 있습니다.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 flex justify-center py-4">
          <Link href="/university">
            <div className="bg-gray-100 shadow-2xl px-8 p-2 rounded-xl font-bold hover:bg-blue-500 hover:text-white transition duration-300 hover:scale-105 m-4">
              희망 학과
            </div>
          </Link>

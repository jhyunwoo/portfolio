    ...
    <div className={'w-full bg-gray-50 dark:bg-gray-900 flex flex-col'}>
      ...
      <div className={'flex'}>
        <div className={'m-4 bg-gray-100 w-full p-4 shadow-xl rounded-xl dark:bg-gray-800'}>
          <div className={'text-2xl font-semibold m-2 dark:text-white'}>Student Teacher</div>
          <div>
            <Image
              src={st}
            ...
            <p className={'text-xl dark:text-white'}>
              Student Teacher 활동을 통해 친구들과 같이 수업을 준비하며 협동력을 발전 시킬 수 있었고
              아직 IT 과정을 밟지 않은 1학년 학생의 눈높이를 기준으로 수업을 구상하는 경험을 할 수
              있었습니다. 수업을 진행하면서 다른 사람에게 지식을 공유하는 것이 쉽지 않다는 것을
              느끼고 기존에 알았던 지식을 좀 더 심도있게 공부할 수 있었습니다. 또한 1학년 학생들의
              고민을 들으며 작년에 고민했던 경험을 떠올릴 수 있었습니다.
            </p>
          </div>
        </div>
      </div>
